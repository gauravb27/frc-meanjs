...
// Use Applicaion configuration module to register a new module -- ENTRIES ADDED
	...
	function($scope, $stateParams, $location, Authentication, Entries) {
		...
		$scope.create = function() {
			var entry = new Entries({
				...
				autohigh: this.autohigh,
				autolow: this.autolow,
				autohot: this.autohot,
				mob: this.mob,
				passm: this.passm,
				passr: this.passr,
				truss: this.truss,
				...
				drat: this.drat,
				dball: this.dball,
				foulone: this.foulone,
				foultwo: this.foultwo,
...
//Entries service used for communicating with the articles REST endpoints
